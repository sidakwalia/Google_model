...
class FBVideoData(AdData):
    def __init__(self, data,mode = "binary"):
        self._LISTVARS = ['nlp_link_description_entities','nlp_title_entities','nlp_body_entities','nlp_video_transcription',
           'vid_all_entities','vid_all_catentities','vision_entities','vision_api_full_text','vid_text_entities']
        self._df = data
        entities = ['nlp_link_description_entities','nlp_title_entities','nlp_body_entities',
           'vid_all_entities','vid_all_catentities','vision_entities','vid_text_entities']
